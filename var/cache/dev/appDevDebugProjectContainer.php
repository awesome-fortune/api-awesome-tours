...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api.response_factory' => 'getApi_ResponseFactoryService',
            ...
            'jwt_token_authenticator' => 'getJwtTokenAuthenticatorService',
    ...
    /**
     * Gets the 'api.response_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Extra\ResponseFactory A Extra\ResponseFactory instance.
     */
    protected function getApi_ResponseFactoryService()
    {
        return $this->services['api.response_factory'] = new \Extra\ResponseFactory();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Extra\ApiExceptionSubscriber A Extra\ApiExceptionSubscriber instance.
     */
    protected function getApiExceptionSubscriberService()
    {
        return $this->services['api_exception_subscriber'] = new \Extra\ApiExceptionSubscriber('%kernel.debug%', $this->get('api.response_factory'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('api_exception_subscriber', 'Extra\\ApiExceptionSubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.10.10', 'port' => 3306, 'dbname' => 'awesome-tours', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/BusBundle/Entity'), 2 => ($this->targetDirs[3].'/src/TripBundle/Entity'), 3 => ($this->targetDirs[3].'/src/BusRouteBundle/Entity'), 4 => ($this->targetDirs[3].'/src/ApiLogsBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UserBundle\\Entity');
        $c->addDriver($b, 'BusBundle\\Entity');
        $c->addDriver($b, 'TripBundle\\Entity');
        $c->addDriver($b, 'BusRouteBundle\\Entity');
        $c->addDriver($b, 'ApiLogsBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'BusBundle' => 'BusBundle\\Entity', 'TripBundle' => 'TripBundle\\Entity', 'BusRouteBundle' => 'BusRouteBundle\\Entity', 'ApiLogsBundle' => 'ApiLogsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dd45bc2a352f89cd63f1437e4cfd6c39eccdc33e8e0fd188aedf1763c3ed7a55');
    ...
    /**
     * Gets the 'jwt_token_authenticator' service.
     *
     * This service is autowired.
     *
     * @return \UserBundle\Security\JwtTokenAuthenticator A UserBundle\Security\JwtTokenAuthenticator instance.
     */
    protected function getJwtTokenAuthenticatorService()
    {
        return $this->services['jwt_token_authenticator'] = new \UserBundle\Security\JwtTokenAuthenticator($this->get('lexik_jwt_authentication.jwt_encoder'), $this->get('doctrine.orm.default_entity_manager'), $this->get('api.response_factory'));
    }
    ...
    {
        $this->services['lexik_jwt_authentication.jwt_manager'] = $instance = new \Lexik\Bundle\JWTAuthenticationBundle\Services\JWTManager($this->get('lexik_jwt_authentication.jwt_encoder'), $this->get('debug.event_dispatcher'), 3600);
    ...
    {
        return $this->services['lexik_jwt_authentication.openssl_key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\OpenSSLKeyLoader(($this->targetDirs[3].'/app/../var/jwt/private.pem'), ($this->targetDirs[3].'/app/../var/jwt/public.pem'), 'sweetcakesandsugar');
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/' => array('allow_origin' => true, 'allow_headers' => array(0 => 'x-custom-auth'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600)), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = $this->get('jwt_token_authenticator');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/BusRouteBundle/Resources/views'), 'BusRoute');
        $instance->addPath(($this->targetDirs[3].'/src/ApiLogsBundle/Resources/views'), 'ApiLogs');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e3347733ca17a5aee50ab869f709b7aa83811944');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BusRouteBundle' => 'BusRouteBundle\\BusRouteBundle',
                'NelmioCorsBundle' => 'Nelmio\\CorsBundle\\NelmioCorsBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'LexikJWTAuthenticationBundle' => 'Lexik\\Bundle\\JWTAuthenticationBundle\\LexikJWTAuthenticationBundle',
                'ApiLogsBundle' => 'ApiLogsBundle\\ApiLogsBundle',
            ...
            'secret' => 'e3347733ca17a5aee50ab869f709b7aa83811944',
            'jwt_key_pass_phrase' => 'sweetcakesandsugar',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e3347733ca17a5aee50ab869f709b7aa83811944',
            ...
            'lexik_jwt_authentication.private_key_path' => ($this->targetDirs[3].'/app/../var/jwt/private.pem'),
            'lexik_jwt_authentication.public_key_path' => ($this->targetDirs[3].'/app/../var/jwt/public.pem'),
            'lexik_jwt_authentication.pass_phrase' => 'sweetcakesandsugar',
